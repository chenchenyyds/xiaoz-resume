...
class TieredRateLimitMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        tier = "admin" if (user and getattr(user, "is_admin", False)) else get_user_tier(user_id)
        ...
        if not allowed:
            return JSONResponse(
                ...
                content={
                    ...
                    "data": {"tier": tier, "endpoint": endpoint, "limit": count, "window": window},
                },
            )
            ...
            if current > count:
                ...
                return JSONResponse(
                    ...
                    content={
                        ...
                        "data": {"tier": tier, "endpoint": endpoint, "retry_after": ttl},
                    },
                )
        except Exception:
            # Redis 挂了不阻塞业务
